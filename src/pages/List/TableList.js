  ...
  columns = [
    {
      title: '规则名称',
      dataIndex: 'name',
      render: text => <Link to={`/list/detail/${text.replace(/\s+/gi, '-')}`}>{text}</Link>,
    },
    {
      title: '描述',
      dataIndex: 'desc',
